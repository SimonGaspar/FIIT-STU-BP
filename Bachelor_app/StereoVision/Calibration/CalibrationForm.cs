    ...
    public partial class CalibrationForm : Form
    {
        ...
        private void ProcessFrame(object sender, EventArgs arg)
        {
            ...
            if (currentMode == Mode.SavingFrames)
            {
                ...
                CvInvoke.FindChessboardCorners(Gray_frame_S1, patternSize, cornerLeft);
                CvInvoke.FindChessboardCorners(Gray_frame_S2, patternSize, cornerRight);

                corners_Left = cornerLeft.ToArray();
                corners_Left = cornerRight.ToArray();
                ...
                if (corners_Left != null && corners_Right != null) //chess board found in one of the frames?
                {
                    ...
                    {
                        //left
                        frameImage_S1.Draw(new LineSegment2DF(corners_Left[i - 1], corners_Left[i]), line_colour_array[i], 2);
                        frameImage_S1.Draw(new CircleF(corners_Left[i], 3), new Bgr(Color.Yellow), 1);
                        //right
                        frameImage_S2.Draw(new LineSegment2DF(corners_Right[i - 1], corners_Right[i]), line_colour_array[i], 2);
            ...
            #endregion
            //display image
            Video_Source1.Image = frameImage_S1.Bitmap;
            Video_Source2.Image = frameImage_S2.Bitmap;
